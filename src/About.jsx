        ...
        <>
            <div class="container">
                <div class="row">
                    ...
                    <div class="get_started-content-options">
                        <ul>
                            <li><a href="#" data-url="hire-now" data-action="hire_coding">
                            ...
                            <li><a href="#" data-url="/signup" data-action="practice"><svg width="47" height="44" viewBox="0 0 47 44" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="svg_icon svg_practice"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.1842 11L11.0015 13.1895L19.6042 21.8125L11.0015 30.4355L13.1842 
